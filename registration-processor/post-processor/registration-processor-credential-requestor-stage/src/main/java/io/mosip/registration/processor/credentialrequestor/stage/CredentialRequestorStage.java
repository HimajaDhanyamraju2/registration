...
public class CredentialRequestorStage extends MosipVerticleAPIManager {
	...
	@Value("${mosip.regproc.credentialrequestor.credissuer.template-id:F72C8C890697}")
	...
	private Map<String, Object> buildCredIssuerRequest(String regId, String uin) {
		...
		issuerInfo.put("org_code", "CHAS-3FC303DF");
		...
		credentialData.put("email", "john.doe@gmail.com");
		...
		credentialData.put("surnameLine2", "DOE");
